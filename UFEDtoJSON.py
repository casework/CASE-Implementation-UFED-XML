...
#		
	...
	def __generateHeader(self):
		...
		line = "".join(['{ \n', \
				...
				UFEDtoJSON.TAB*2 + '"@vocabulary":"http://example.org/kb/", \n', \
				UFEDtoJSON.TAB*2 + '"kb": "http://example.org/kb/", \n', \
				UFEDtoJSON.TAB*2 + '"not-in-ontology":"https://not-in/ontology/", \n', \
				UFEDtoJSON.TAB*2 + '"drafting":"http://example.org/ontology/drafting/", \n', \
				...
				UFEDtoJSON.TAB + '},\n', \
				UFEDtoJSON.TAB +'"@id":":bundle-' + uuid + '", \n', \
				UFEDtoJSON.TAB +'"@type":"uco-core:Bundle",\n', \
				UFEDtoJSON.TAB +'"uco-core:specVersion":"CASE 1.0.0",\n', \
				UFEDtoJSON.TAB +'"uco-core:description":"Extraction from XML report generated by UFED PA",\n', \
				UFEDtoJSON.TAB +'"uco-core:object": [\n'])
