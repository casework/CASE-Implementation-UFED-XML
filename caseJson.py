...
class CaseJson:
	...
	def __generateTraceAppAccount(self, source, name, identifier, idApp, idIdentity):
		...
		line = "".join(['{ \n', \
			...
			CaseJson.C_TAB + '"@type":"uco-observable:ObservableObject", \n', \
			CaseJson.C_TAB + '"uco-observable:hasChanged":true,\n',\
			CaseJson.C_TAB + '"uco-core:hasFacet":[ \n', \
			CaseJson.C_TAB*2 + '{ \n', \
			CaseJson.C_TAB*3 + '"@type":"uco-observable:AccountFacet", \n', \
		...
		#line += CaseJson.C_TAB*2 + '"uco-observable:accountIssuer":"' + idIdentity + '", \n'
			...
			CaseJson.C_TAB*2 + '},\n', \
			CaseJson.C_TAB*2 + '{ \n', \
			CaseJson.C_TAB*3 + '"@type":"uco-observable:DigitalAccountFacet", \n', \
	...
	def __generateTraceAppName(self, appName):
		...
		#line += CaseJson.C_TAB + '"uco-core:name":"' + appName + '",\n'
			CaseJson.C_TAB + '"uco-core:hasFacet":[ \n', \
			CaseJson.C_TAB*2 + '{ \n', \
			CaseJson.C_TAB*2 + '"@type":"uco-observable:ApplicationFacet", \n', \
...
#		
	...
	def __generateTraceAppIdentity(self, appName):
		...
		line = "".join(['{ \n', \
			CaseJson.C_TAB + '"@id":"' +  uuid + '", \n', \
			CaseJson.C_TAB + '"@type":"uco-observable:IdentityFacet", \n', \
			CaseJson.C_TAB + '"uco-core:hasFacet":[ \n', \
			CaseJson.C_TAB*2 + '{ \n', \
			CaseJson.C_TAB*2 + '"@type":"uco-observable:OrganizationFacet", \n', \
...
# included in the	uco-observable:PhoneAccount				
	...
	def __generateTraceChat(self, body, idApplication, timeStamp, idFrom,
		...
		line = "".join(['{ \n', \
			...
			CaseJson.C_TAB + '"uco-core:hasFacet":[\n', \
			CaseJson.C_TAB*2 + '{\n', \
			CaseJson.C_TAB*2 + '"@type":"uco-observable:MessageFacet", \n', \
...
#
	...
	def __generateTraceDevice(self, deviceMAC, deviceSN, deviceModel,
		...
		line = "".join(['{ \n', \
			...
			CaseJson.C_TAB + '"uco-core:hasFacet":[\n', \
			CaseJson.C_TAB*2 + '{\n', \
			CaseJson.C_TAB*3 + '"@type":"uco-observable:DeviceFacet",\n', \
			CaseJson.C_TAB*3 + '"uco-observable:model":"' + deviceModel + '",\n', \
			CaseJson.C_TAB*3 + '"uco-observable:serialNumber":"' + deviceSN + '"\n', \
			CaseJson.C_TAB*2 + '},\n', \
			CaseJson.C_TAB*2 + '{\n', \
			CaseJson.C_TAB*3 + '"@type":"uco-observable:MobileDeviceFacet",\n', \
...
#
		...
		#line += CaseJson.C_TAB*2 + '"uco-observable:clockSetting":"NOT_PROVIDED"\n'
			CaseJson.C_TAB*2 + '},\n' , \
			CaseJson.C_TAB*2 + '{\n', \
			CaseJson.C_TAB*2 + '"@type":"uco-observable:OperatingSystemFacet",\n', \
...
#
		...
		#line += CaseJson.C_TAB*2 + '},\n'
			CaseJson.C_TAB*2 + '{\n', \
			CaseJson.C_TAB*2 + '"@type":"uco-observable:BluetoothAddressFacet",\n', \
			CaseJson.C_TAB*2 + '"uco-observable:addressValue":"' + deviceBluetoothAddress + '"\n', \
			CaseJson.C_TAB*2 + '},\n ', \
			CaseJson.C_TAB*2 + '{\n', \
			CaseJson.C_TAB*2 + '"@type":"uco-observable:WifiAddressFacet",\n', \
...
#		
		...
		line = "".join(['{ \n', \
			...
			CaseJson.C_TAB + '"uco-core:hasFacet":[\n', \
			CaseJson.C_TAB*2 + '{\n', \
			CaseJson.C_TAB*2 + '"@type":"uco-observable:EmailMessageFacet",\n', \
...
#		
	...
	def __generateTraceEmailAddress(self, address):
		...
		line = "".join(['{ \n', \
			...
			CaseJson.C_TAB + '"uco-observable:hasChanged":true,\n',\
			CaseJson.C_TAB + '"uco-core:hasFacet":[{\n', \
			CaseJson.C_TAB*2 + '"@type":"uco-observable:EmailAddressFacet", \n', \
	...
	def __generateTraceFile(self, FILEpath, FILEsize, FILEhashType, 
		...
		if  FILEsize.strip == '0':
			...
			sizeFile = "".join([CaseJson.C_TAB*2 + '},\n' ,\
				CaseJson.C_TAB*2 + '{\n',\
				CaseJson.C_TAB*2 + '"@type":"uco-observable:ContentDataFacet",\n',\
		...
		line = "".join(['{ \n', \
			...
			CaseJson.C_TAB + '"uco-core:hasFacet":[\n', \
			CaseJson.C_TAB*2 + '{\n', \
			CaseJson.C_TAB*2 + '"@type":"uco-observable:FileFacet",\n', \
...
#				
	...
	def __generateTracePhoneAccount(self, Source, Name, PhoneNum):
		...
		line = "".join(['{ \n', \
			...
			CaseJson.C_TAB*2 + '}, \n',\
			CaseJson.C_TAB*2 + '{ \n',\
			CaseJson.C_TAB*2 + '"@type":"uco-observable:PhoneAccountFacet", \n',\
...
#			
	...
	def __generateTracePhoneCall(self, direction, startTime, idFROM, idTO, 
		...
		line = "".join(['{ \n', \
			...
			CaseJson.C_TAB + '"uco-core:hasFacet":[ \n',\
			CaseJson.C_TAB*2 + '{ \n',\
			CaseJson.C_TAB*2 + '"@type":"uco-observable:PhoneCallFacet", \n',\
...
#	
	...
	def __generateTraceRelation(self, source, target, relation, table, offset):
		...
		line = "".join(['{ \n', \
			CaseJson.C_TAB + '"@id":"' +  uuid + '", \n',\
			CaseJson.C_TAB + '"@type":"uco-observable:ObservableRelationship",\n',\
...
#
	...
	def __generateThreadMessages(self, chatTraceId, chatThread, chatIdAccountList):
		...
		line = "".join(['{ \n', \
			...
			CaseJson.C_TAB + '"uco-core:hasFacet":[\n',\
			CaseJson.C_TAB*2 + '{\n',\
			CaseJson.C_TAB*2 + '"@type":"uco-observable:MessageThreadFacet",\n',\
	...
	def __generateTraceTool(self, name, type, vendor, version, confList):
		...
		if len(confList) > 0:  
			line += line + ',\n'
			line += CaseJson.C_TAB + '"uco-core:hasFacet":[\n'
			line += CaseJson.C_TAB*2 + '{\n'
			...
			line += CaseJson.C_TAB*2 + '{\n'
			line += CaseJson.C_TAB*2 + '"@type":"uco-observable:ConfigurationSettingFacet",\n'
	...
	def __generateTraceURL (self, URL_Value):
		...
		line = "".join(['{ \n', \
			...
			CaseJson.C_TAB + '"uco-core:hasFacet":[\n',\
			CaseJson.C_TAB*2 + '{\n',\
			CaseJson.C_TAB*2 + '"@type":"uco-observable:URLFacet", \n',\
...
#
			...
			#line += CaseJson.C_TAB + '"@type":"uco-observable:ObservableObject", \n'
			#line += CaseJson.C_TAB + '"uco-core:hasFacet":[\n'
			#line += CaseJson.C_TAB*2 + '{\n'
