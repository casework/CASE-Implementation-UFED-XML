# CASE-Implementation-UFED-XML## XML SAX parser for UFED/Cellebrite. Tht tool extracts some digital traces (Cyber itrems) from XML reports generated by UFED PA (version 7.x) and convert them into CASE as JSON-LD files.
